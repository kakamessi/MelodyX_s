package com.angelmusic.student.constant;
...
public class Constant {
    ...
    public static final String PLAY_TOGHTER_COMPLETE_ONE = "14";   //一起弹奏吧 完整奏1
    public static final String PLAY_TOGHTER_COMPLETE_TWO = "15";   //一起弹奏吧 完整奏2

    public static final String REVIEW_PLAY_FOLLOW_ONE = "22";      //回课       跟奏1
    public static final String REVIEW_PLAY_FOLLOW_TWO = "23";      //回课       跟奏2
    ...
    public static final String PLAY_TOGHTER_DEMONSTRATE_TWO = "91";    //一起弹奏吧 示范奏
    public static final String PLAY_TOGHTER_FOLLOW_ONE_TWO = "92";     //一起弹奏吧 跟奏1
    public static final String PLAY_TOGHTER_FOLLOW_TWO_TWO = "93";     //一起弹奏吧 跟奏2
    public static final String PLAY_TOGHTER_COMPLETE_ONE_TWO = "94";   //一起弹奏吧 完整奏1
    public static final String PLAY_TOGHTER_COMPLETE_TWO_TWO = "95";   //一起弹奏吧 完整奏2
    ...
    public static final int COURSE_6 = 720;
    public static final int COURSE_8 = 735;
    public static final int COURSE_9 = 747;
